    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              ...
              GestureDetector(onTap: () {
                _openModelSheet(context, widget.post);
          ...
          sizeVer(10),
          Text("View all ${widget.post.totalComments} comments", style: TextStyle(color: primaryColor),),
          sizeVer(10),
          Text("${DateFormat("dd/MMM/yyy").format(widget.post.createAt!.toDate())}", style: TextStyle(color: primaryColor),),
        ],
      ),
    );
  }

  _openModelSheet(BuildContext context, PostEntity post) {
